...
See [docs/AGENT_COORDINATION.md](docs/AGENT_COORDINATION.md) for coordination rules and [docs/tasks/claude-next.md](docs/tasks/claude-next.md) for the current task queue.
...
- [docs/context/NEXT_SESSION.md](docs/context/NEXT_SESSION.md)
